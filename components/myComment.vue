                ...
                <div :id="'comment-'+comment.id" :keys="index" v-for="(comment,index) in comments" class="comment">
                    ...
                    <div class="sub-comment-list">
                        <div v-show="comment.children.length != 0">
                            <div v-for="(subComment,nindex) in comment.children" :id="'comment-' + subComment.id"
                                ...
                                <div class="sub-tool-group">
                                    ...
                                    <a href="javascript:void(0)"
                                       @click="showSubCommentForm(index,subComment.id,subComment.user.nick_name)">
                                        <i class="fa fa-comment-o"></i>
                                        <span>回复</span>
                                    </a>
                                </div>
                            ...
                            <div class="sub-comment more-comment">
                                <a class="add-comment-btn" @click="showSubCommentForm(index,)"
                            ...
                            <form v-if="activeIndex.includes(index)" class="new-comment">
                                ...
                                <div class="write-function-block clearfix">
                                    ...
                                    <a class="btn btn-send" href="javascript:void(0)"
                                       @click="sendSubCommentData(index)">
                                        发送
                                    </a>
