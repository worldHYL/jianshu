      ...
      <div class="row">
          <div class="col-8 main" >
             <div class="main-top">
                 ...
                 <div class="title">
                  <nuxt-link to="/u/123" class="name">时间即金钱</nuxt-link>
                 </div>
                 <div class="info">
                  <ul>
                      <li>
                          <div class="meta-block">
                              <nuxt-link to="/u/123/following">
                              <p>1</p>
                              关注
                    ...
                    <li>
                      <div class="content">
                          <div class="author">
                              ...
                              <div class="info">
                                  <nuxt-link to="/u/123" class="nickname">昨天今天明天</nuxt-link>
                          ...
                          <p class="abstract">
                              《昨天今天明天》是赵本山、宋丹丹、崔永元在1999年中央电视台春节联欢晚会上表演的小品。这是赵本山小品“白云黑土系列”的第一个，由此开创了赵本山小品系列化，是小品王赵本山的里程碑之作。
                          </p>
                          <div class="meta">
                              <nuxt-link to="/p/123">
                              ...
                              <a href="javascript:void(0)" class="cancel">取消喜欢</a>
                          </div>
                      </div>
                    </li>
                  </ul>
          ...
          <div class="col-4 aside clearfix" >
              ...
              <!--专题和文集-->
               <div>
                 <div class="title change" >我创造的专题</div>
                 <div class="new-collection-block">
                     <nuxt-link to="/collections/new" class="new-collection-btn">
               ...
               <div>
                      <div class="title change" >我的文集</div>
                       <ul class="list">
                           <li>
                               <nuxt-link to="/nb/123">
...
export default {
  ...
  data() {
    return {
      like: false,
      followed: false,
      triggers: ["关注的专题/文集/连载 15", "喜欢的文章 88"],
      notes: [
        {
...
.main .nost-list .author {
  margin-bottom: 7px;
  font-size: 13px;
}
.main .nost-list .author .avatar {
  display: inline-block;
  margin-right: 5px;
}
.main .nost-list .author .info {
  display: inline-block;
  vertical-align: middle;
}
.nost-list .author .info span {
  padding-left: 3px;
  color: #969696;
}
.nost-list .content .title {
  margin-bottom: 4px;
  font-size: 18px;
  font-weight: 700;
  display: inline-block;
...
.nost-list li.have-img {
  min-height: 140px;
}
.nost-list .have-img .wrap-img {
  position: absolute;
  right: 0;
  top: 50%;
  margin-top: -68px;
...
.nost-list .have-img .wrap-img img {
  width: 100%;
  height: 100%;
  border-radius: 4px;
